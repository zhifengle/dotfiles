...
// 2019-02-02  By alan
// 老机器减少内存
pref("toolkit.cosmeticAnimations.enabled", false); // 标签动画
pref("extensions.webextensions.remote", false); // 扩展
pref("media.gpu-process-decoder", false);
pref("layers.gpu-process.enabled", false);
pref("javascript.options.mem.high_water_mark", 16); // 62以上版本
...
user_pref("browser.tabs.warnOnClose", false); //关闭所有标签页时不提醒
...
//user_pref("browser.tabs.closeTabByDblclick", true); //开启双击关闭标签 (ff64+，但关闭标签有延迟)


user_pref("privacy.userContext.enabled", true);//开启身份标签页
user_pref("browser.tabs.remote.warmup.enabled", true); //提高标签页切换速度 (ff61+)
user_pref("browser.tabs.tabMinWidth", 100);//标签最小宽度
user_pref("browser.tabs.insertAfterCurrent", true);//紧邻当前标签页打开(ff64+)
user_pref("browser.bookmarks.openInTabClosesMenu", true);//点击书签不关闭菜单
...
// 历史侧边栏打开链接可以使用鼠标中键点击，或者按住Ctrl键点击链接。
...
user_pref("browser.newtabpage.pinned", "[{\"url\":\"https://bgm.tv/\",\"label\":\"Bangumi\"},{\"url\":\"https://twitter.com\",\"label\":\"Twitter\"},{\"url\":\"https://tieba.baidu.com/\",\"label\":\"Tieba\"},{\"url\":\"https://www.bilibili.com\",\"label\":\"Bilibili\"},{\"url\":\"http://music.163.com\",\"label\":\"Music\"},{\"url\":\"http://www.zhihu.com\",\"label\":\"Zhihu\"},{\"url\":\"http://www.guokr.com\",\"label\":\"Guokr\"},{\"url\":\"http://www.douban.com\",\"label\":\"Douban\"}]");
